...
<div class="container">
    <div class="wsus__details_bg">
        <div class="row">
            <div class="col-xl-4 col-md-5 col-lg-5 z-ind">
                <div id="sticky_pro_zoom">
                    <div class="exzoom hidden" id="exzoom">
                        <div class="exzoom_img_box">
                            ...
                            {{-- @if(isset($product) && isset($product->thumb_image))
                            <ul class="exzoom_img_ul">
            ...
            <div class="col-xl-7 col-md-7 col-lg-7">
                <div class="wsus__pro_details_text">
                    ...
                    <ul class="wsus__button_area">
                        ...
                        {{-- <li><a class="buy_now" href="#">buy now</a></li> --}}
                        <li><a href="" class="wish_list heart_button" data-id="{{$product->id}}"><i class="far fa-heart"></i></a></li>
                        {{-- <li><a href="#"><i class="far fa-random"></i></a></li> --}}
                    </ul>
                </form>
...
<div class="wsus__comment_area">
    ...
    <div class="wsus__main_comment">
        ...
        <div class="wsus__comment_text reply">
            ...
            <ul class="">
                @if ($review->productReviewGallery->count()>0)
...
<div class="wsus__post_comment rev_mar" id="sticky_sidebar3">
    ...
    <div class="row ">
        ...
        <div class="col-md-6">
            <label for="rating" class="mt-2">Select your rating:</label>
        </div>
        <div class="col-md-6">
        ...
        <div class="img_upload">
            <div class="gallery">
                <a class="cam" href="javascript:void(0)" name="image[]"><span><i
