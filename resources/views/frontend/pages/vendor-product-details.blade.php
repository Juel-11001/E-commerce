                        ...
                        <div class="col-xl-6 col-12 col-sm-10 col-md-8 col-lg-6 m-auto display">
                            <div class="wsus__quick_view_img">
                                ...
                                <div class="row modal_slider">
                                 ...
                                 {{-- static image for only one picture is product // work this for later --}}
                               ...
                               <span>{{count($product->reviews)}} review</span>
                                ...
                                <form class="shopping-cart-form">
                                    ...
                                    <ul class="wsus__button_area">
                                        ...
                                        <li><a href="" class="wish_list" data-id="{{$product->id}}"><i class="fal fa-heart"></i></a></li>
                            ...
                            <div class="col-xl-3  col-sm-6">
                                <div class="wsus__product_item">
                                    ...
                                    <div class="wsus__product_details">
                                        ...
                                        <a class="wsus__pro_name" href="{{route('product-detail', $product->slug)}}">{{limitText($product->name, 44)}}</a>
                                        @if (checkDiscount($product))
