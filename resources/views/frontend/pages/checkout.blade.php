            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7">
                    <div class="wsus__check_form">
                        <h5 class="d-flex align-items-center">Billing Details <a href="#" data-bs-toggle="modal" class="ms-auto common_btn" data-bs-target="#exampleModal">add
                                new address</a></h5>
                        <div class="row">
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="wsus__order_details" id="sticky_sidebar">
                        ...
                        <div class="wsus__order_details_summery">
                            ...
                            <p>shipping fee: <span id="shipping_fee">{{$settings->currency_icon}}00.00</span></p>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            // reset the value of shipping_method_id and shipping_address_id
            ...
            $('.shipping_method').on('click', function() {
                ...
                let total=currentTotalAmount+shippingFee;
                $('#shipping_method_id').val($(this).val());
                $('#shipping_fee').text("{{$settings->currency_icon}}" + shippingFee);
                $('#total_amount').text("{{$settings->currency_icon}}" + total);
            })
            // shipping address
            ...
            $('#submitCheckoutForm').on('click', function(e) {
                ...
                if($('#shipping_method_id').val() == ""){
                    ...
                    toastr.error("Please agree with our terms and condition!");
                }else{
                    $.ajax({
                        ...
                        beforeSend: function() {
                            $('#submitCheckoutForm').html('<i class="fas fa-spinner fa-spin fa-1x"></i> Please wait...');
                        },
                        success: function(data) {
                            if(data.status==='success'){
                                $('#submitCheckoutForm').html('Place Order');
                                //redirect user to next page [payment]
