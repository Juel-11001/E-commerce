                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="wsus__contact_single">
                                    ...
                                    <a href="#" target="_blank">{{$settings->contact_address}}</a>
                            ...
                            <form id="contactForm">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <button type="submit" class="common_btn" id="form_submit">send now</button>
                                    </div>
                                </div>
                            </form>
                        </div>
