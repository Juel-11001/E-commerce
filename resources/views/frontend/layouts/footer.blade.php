@php
    ...
    $footerGridTwo=Cache::rememberForever('footer_grid_two', function () {
        return \App\Models\FooterGridTwo::where('status', 1)->get();
    });
    $footerGridThree=Cache::rememberForever('footer_grid_three', function () {
        ...
        <div class="row justify-content-between">
            <div class="col-xl-3 col-sm-7 col-md-6 col-lg-3">
                <div class="wsus__footer_content">
                    <a class="wsus__footer_2_logo" href="{{route('fronted.home')}}">
                    ...
                    <ul class="wsus__footer_social">
                        ...
                        <li><a class="facebook" target="_blank" href="{{$link->url}}"><i class="{{$link->icon}}"></i></a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-sm-7 col-md-8 col-lg-5">
                <div class="wsus__footer_content wsus__footer_content_2">
                    ...
                    <form action="" id="newsletter" method="post">
                        @csrf
                        <input type="text" placeholder="Email" name="email" class="newsletter-email">
                        <button type="submit" class="common_btn subscriber_btn">subscribe</button>
                    </form>
