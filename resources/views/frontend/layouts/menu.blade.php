            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus_menu_cat_item show_home toggle_menu">
                        ...
                        <li><a class="{{count($category->subCategories) > 0 ? 'wsus__droap_arrow' : ''}}" href="{{route('products.inex',['category'=>$category->slug])}}"><i class="{{$category->icon}}"></i> {{$category->name}} </a>
                            ...
                            <ul class="wsus_menu_cat_droapdown">
                                ...
                                <li><a href="{{route('products.inex',['sub_category'=>$sub_category->slug])}}">{{$sub_category->name}} <i class="{{count($sub_category->childCategories)>0 ? 'fas fa-angle-right' : ''}}"></i></a>
                                    ...
                                    <ul class="wsus__sub_category">
                                        ...
                                        <li><a href="{{route('products.inex',['child_category'=>$childCategory->slug])}}">{{$childCategory->name}}</a> </li>
                    ...
                    <ul class="wsus__menu_item">
                        <li><a class="{{setActive(['fronted.home'])}}" href="{{route('fronted.home')}}">home</a></li>
...
<section id="wsus__mobile_menu">
    ...
    <ul class="wsus__mobile_menu_header_icon d-inline-flex">
        ...
        <li><a href="{{route('user.wish-list.index')}}"><i class="fal fa-heart"></i><span id="wishlist_count">
            @if (Auth::check())
    ...
    <form action="{{route('products.inex')}}">
                                ...
                                <div id="flush-collapseThreew-{{$loop->index}}" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <ul>
                                            ...
                                            <li><a href="{{route('products.inex',['category'=>$categoryItem->slug])}}">{{$subCategory->name}}</a></li>
                                            @endforeach
