    ...
    <div class="row">
        <div class="col-xl-6 col-12 col-sm-10 col-md-8 col-lg-6 m-auto display">
            <div class="wsus__quick_view_img">
                ...
                <div class="row modal_slider">
                 ...
                 {{-- if need product slider then we work to here --}}
                {{-- @if(count($product->productImageGallerys) === 0)
                <div class="col-xl-12">
                    <div class="modal_slider_img">
                        <img src="{{asset($product->thumb_image)}}" alt="{{$product->name}}" class="img-fluid w-100">
                    </div>
                ...
                @endif
                @foreach ($product->productImageGallerys as $image)
                <div class="col-xl-12">
                    <div class="modal_slider_img">
        ...
        <div class="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
            <div class="wsus__pro_details_text">
                <a class="title" href="#">{!!limitText($product->name, 65)!!}</a>
               ...
               @endfor
                ...
                <p class="description">{!! limitText($product->short_description, 122) !!}</p>
                ...
                <form class="shopping-cart-form">
                    ...
                    <ul class="wsus__button_area">
                        ...
                        {{-- <li><a class="buy_now" href="#">buy now</a></li> --}}
                        <li><a href="#" class="wish_list heart_button" data-id="{{$product->id}}"><i class="fal fa-heart"></i></a></li>
                        {{-- <li><a href="#"><i class="far fa-random"></i></a></li> --}}
                    </ul>
                </form>
