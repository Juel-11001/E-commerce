        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-7 col-md-8 col-lg-2">
                <div class="wsus_logo_area">
                    <a class="wsus__header_logo" href="{{route('fronted.home')}}">
        ...
        <ul class="mini_cart_wrapper">
            ...
            @foreach (Cart::content() as $sidebarProduct)
                <li id="mini_cart_{{$sidebarProduct->rowId}}">
                    <div class="wsus__cart_img">
                        <a href="{{route('product-detail', $sidebarProduct->options->slug)}}"><img src="{{asset($sidebarProduct->options->image)}}" alt="" class="img-fluid w-100"></a>
                    ...
                    <div class="wsus__cart_text">
                        ...
                        <small>Qty: {{$sidebarProduct->qty}}</small> <br>
