                ...
                <form action="{{ route('admin.shipping-rule.update', $shipping_rule->id) }}" method="post">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="inputState" class="form-control shipping-type" name="type">
                            ...
                            <option {{$shipping_rule->type==='flat_cost' ? 'selected' : ''}} value="flat_cost">Flat</option>
                            <option {{$shipping_rule->type==='min_cost' ? 'selected' : ''}} value="min_cost">Minimum Order Amount</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="inputState" class="form-control" name="status">
                            ...
                            <option {{$shipping_rule->status==0 ? 'selected' : ''}} value="0">Inactive</option>
                        </select>
                    </div>
                </div>
