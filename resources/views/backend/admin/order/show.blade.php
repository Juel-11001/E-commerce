            ...
            <div class="table-responsive">
                ...
                <tr>
                    <td>{{++$loop->index}}</td>
                        ...
                        @if (count($variants) > 0)
                        @foreach ($variants as $key => $variant)
                            <td>{{ $key }}: {{ $variant['name']?? 'N/A' }}({{$settings->currency_icon}}{{ $variant['price']}}) <br>
                                {{ $variant['size'] ?? '' }}
                            </td>
                        @endforeach
                    @else
                    ...
                    <td class="text-right">{{$settings->currency_icon}}{{($product->unit_price * $product->qty) + $product->variants_total*$product->qty}}</td>
                </tr>
                @endforeach
                </table>
            </div>
            <div class="row mt-4">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <select name="product_name" id="payment_status" class="form-control" data-id="{{$order->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="product_name" id="order_status" class="form-control" data-id="{{$order->id}}">
