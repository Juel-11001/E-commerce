<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
      ...
      <li><a class="" href="{{route('fronted.home')}}"><i class="fas fa-home"></i>Go To Home</a></li>
      <li><a class="{{setActive(['vendor.products.*', 'vendor.products-image-gallery.*', 'vendor.products-variant.*'])}}" href="{{route('vendor.products.index')}}"><i class="fas fa-cart-plus"></i>Products</a></li>
      <li><a class="{{setActive(['vendor.orders.*', 'vendor.orders.show'])}}" href="{{route('vendor.orders.index')}}"><i class="fas fa-box"></i>Orders</a></li>
