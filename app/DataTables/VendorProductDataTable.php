...
class VendorProductDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $editBtn= "<a href='".route('vendor.products.edit', $query->id)."'class='btn btn-primary marg-r'><i class='far fa-edit'></i></a>";
            $deleteBtn= "<a href='".route('vendor.products.destroy', $query->id)."'class='btn btn-danger ml-2 delete-item'><i class='fas fa-trash'></i></i></a>";
            $moreBtn='<div class="btn-group dropstart mg-l">
        ...
        ->addColumn('image', function($query){
            ...
            ->addColumn('type', function($query){
                switch ($query->product_type) {
                    case 'new_arrival':
                        return '<i class="badge bg-success">New Arribal</i>';
                        break;
                    case 'featured_product':
                        return '<i class="badge bg-warning">Freatured Product</i>';
                        break;
                    case 'top_product':
