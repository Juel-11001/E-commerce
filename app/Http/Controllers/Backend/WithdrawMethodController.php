...
class WithdrawMethodController extends Controller
{
    ...
    {
        return $dataTable->render('backend.admin.withdraw-method.index');
    }
    ...
    {
        return view('backend.admin.withdraw-method.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $method->save();
        toastr('Withdraw Method created Successfully!', 'success', 'Success');
    ...
    public function edit(string $id)
    {
        ...
        return view('backend.admin.withdraw-method.edit', compact('method'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $method->description=$request->description;
        $method->save();
        toastr('Withdraw Method updated Successfully!', 'success', 'Success');
        return redirect()->route('admin.withdraw-method.index');
